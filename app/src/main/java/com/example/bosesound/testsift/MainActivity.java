package com.example.bosesound.testsift;
...
public class MainActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private void initializeOpenCVDependencies() throws IOException {
       ...
       // AssetManager assetManager1 = getAssets();
        ...
        //InputStream test1 = assetManager1.open("zzz.jpeg");
        //InputStream test2 = assetManager2.open("ccc.jpeg");
...
//        for (int i = 0; i < matchesList.size(); i++) {
//            if (matchesList.get(i).distance <= (3.0 * min_dist))
...
//        }
       ...
       // Features2d.drawMatches(img1, keypoints1, img2, keypoints3, goodMatches, outputImg, GREEN, RED, drawnMatches, Features2d.NOT_DRAW_SINGLE_POINTS);
       // Imgproc.resize(outputImg, outputImg, aInputFrame.size());
        Features2d.drawMatches(img1,keypoints1,img2,keypoints3,matches,outputImg,GREEN, RED,  drawnMatches, Features2d.NOT_DRAW_SINGLE_POINTS);
